...
import ChangeRecieveEmailNotifications from "./settingsFeatures/ChangeRecieveEmailNotifications";
    ...
    <>
      <Wrapper>
        ...
        <FlexContainer>
          ...
          <ProfileSettingsCard title={`Recieve Email Notifications`}>
            <ChangeRecieveEmailNotifications />
          </ProfileSettingsCard>
        </FlexContainer>
      </Wrapper>
    </>
